          ...
          <div class="col">
            <div class="row">
              <div class="col"> <img class="alignnone wp-image-47 size-full"
                  src="http://localhost/wordpress/zia-homes/wp-content/uploads/sites/35/2019/02/bg-chairs.jpg" alt=""
                  width="543" height="624" /></div>
              <div class="col">
                <h1>When it Comes to Investing in Real Estate, Choose the Best Option That’s Out There —
                  Choose Zia Homes</h1>
                <p>Real estate is no joke. The process of investing in a piece of land is both exciting
                  and daunting all at once. Everything from choosing a home builder to finding the
                  right lender and the twists and turns of making one decision after another. But when
                  you finally arrive at that finish line and the keys of your new home are handed over
                  to you, you can take a deep breath and be at peace knowing the best part of your
                  journey is now underway.</p>
                <p>When you invest in real estate, it’s important to know who you’re working with. Their
                  values should reflect the type of principles you wish to see in a builder. It’s
                  important to feel secure working with your home builder as you’ll be communicating
                  with them for months to come. At Zia Homes, we use every conversation as an
                  opportunity to build a foundation of trust and credibility. We’re interested in your
                  real estate goals and it is our mission to bring them to life!</p>
                <h2>Our Company’s History</h2>
                <p>Zia Homes’ story begins in 1985 when Ronald Costa began building roughly ten homes
                  per year. As a small home builder in the 80s’, Costa played a role in El Paso’s
                  residential growth. His vision and determination to create affordable, quality homes
                  quickly grew to 100 homes per year.</p>
                <p>Today, Zia Homes builds with the modern family in mind. As a family-friendly home
                  builder, we take into account the needs of all types, sizes, and age groups of
                  families. We make our homes affordable so that new families can begin an exciting
                  chapter with the ability to build memories in the kitchen, backyard, gathering room,
            ...
            <div class="img-row">
              ...
              <div class="d-flex row text-center img-row">
                <div class="col"> <img class="alignnone wp-image-54 size-full"
                    src="http://localhost/wordpress/zia-homes/wp-content/uploads/sites/35/2019/02/viviana.jpg" alt=""
                    width="406" height="352" />
                  <p>
                ...
                <div class="col"> <img class="alignnone wp-image-56 size-full"
                    src="http://localhost/wordpress/zia-homes/wp-content/uploads/sites/35/2019/02/rene.jpg" alt=""
                    width="406" height="352" />
                  <p>
                ...
                <div class="col"> <img class="alignnone wp-image-57 size-full"
                    src="http://localhost/wordpress/zia-homes/wp-content/uploads/sites/35/2019/02/ana.jpg" alt=""
                    width="406" height="352" />
                  <p>
            ...
            <div><img class="alignleft size-full wp-image-73"
                src="http://localhost/wordpress/zia-homes/wp-content/uploads/sites/35/2019/02/handshake.jpg" alt="" />
