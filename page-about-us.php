<?php get_header(); ?><?php get_template_part('template-parts/page/page', 'top-banner'); ?><section id="main">
    <article>
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col"> <img class="alignnone wp-image-47 size-full"
                                    src="http://localhost/wordpress/zia-homes/wp-content/uploads/sites/35/2019/02/bg-chairs.jpg"
                                    alt="" width="543" height="624" /></div>
                            <div class="col">
